from cogs import ping, ghostping, asked, react, symouse, insult, leseird, nemertem, faszopo, dummy_police, balint_reacting, mivan
...
async def add_all_cogs(bot):
    ...
    await bot.add_cog(mivan.Mivan(bot))